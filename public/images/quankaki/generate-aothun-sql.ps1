...
# CONFIG
# ===============================
$folder      = 'C:\xampp\htdocs\hanzo-shop\public\images\quankaki'
$outProducts = Join-Path $folder 'insert-aothun-products.sql'
$outImages   = Join-Path $folder 'insert-aothun-images.sql'

# category_id của Áo Thun trong bảng categories
$catId = 18   # nếu khác thì sửa lại số này
